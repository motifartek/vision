...
export function MorphSurface({
  ...
  return (
    <div
      className={cn("flex justify-center items-end relative z-50", className)}
      style={{
        width: "100%",
    ...
    >
      <motion.div
        ...
        className={cn(
          "absolute bottom-0 flex flex-col items-center z-50 overflow-hidden",
        ...
        animate={{
          ...
          borderRadius: showFeedback ? expandedBorderRadius : collapsedBorderRadius,
        }}
        transition={
          springConfig || {
            type: "spring",
...
function MorphSurfaceDock() {
  ...
  const defaultTrigger = (
    <button
      type="button"
      className={cn(
        "m-[-8px] flex justify-end rounded-sm p-2 flex-1 gap-1",
  ...
  return (
    <footer className="flex items-center justify-between select-none whitespace-nowrap mt-auto h-[44px] w-full px-4">
      ...
      <div className="flex justify-between py-1">
        ...
        <button
          ...
          className={cn(
            ...
            "rounded-sm cursor-pointer pr-1",
  ...
  return (
    ...
    >
      ...
      {showFeedback && (
        <motion.div
          layoutId={`morph-surface-dot-${triggerLabel}`}
          className="w-2 h-2 bg-primary rounded-sm absolute top-[18.5px] left-4"
          transition={logoSpring}
        />
      )}
    </form>
...
function Kbd({
  ...
  return (
    <kbd
      className={cn(
        "w-6 h-6 bg-muted text-muted-foreground rounded-sm flex items-center justify-center font-sans px-[6px] text-xs border",
        className
      )}
    >
      {children}
